...
set_property PACKAGE_PIN J18 [get_ports {blue[2]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {blue[2]}]
...
set_property PACKAGE_PIN B17 [get_ports kbdDataIn]					
	set_property IOSTANDARD LVCMOS33 [get_ports kbdDataIn]	
	set_property PULLUP true [get_ports kbdDataIn]
